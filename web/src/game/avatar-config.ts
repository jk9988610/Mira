...
/** 圆寿命剩余值上限（秒） */
export const LIFESPAN_CAP_SEC = 720
...
/** 自然闲逛：换向间隔与转向平滑 @deprecated 已移除闲逛 */
...
/** 饱食/快乐/交配降低压力释放的上限与权重 */
export const PRESSURE_RELIEF_MAX = 0.72
export const PRESSURE_RELIEF_SATIETY_WEIGHT = 0.28
export const PRESSURE_RELIEF_JOY_WEIGHT = 0.22
export const PRESSURE_RELIEF_MATING_ACTIVE = 0.35
export const PRESSURE_RELIEF_POST_MATE = 0.18

/** 地图资源格子与地块 */
export const RESOURCE_GRID_COLS = 12
export const RESOURCE_GRID_ROWS = 7
export const RESOURCE_ZONE_LIFETIME_SEC = 99
